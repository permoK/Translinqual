            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl">
                  Luo (Dholuo) AI Chat Platform
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Experience the power of AI-driven conversations in Luo (Dholuo) language with our specialized translation model
                </p>
              </div>
        ...
        <section className="py-12 md:py-24 bg-white dark:bg-gray-900" id="languages">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="mt-4 text-gray-500 dark:text-gray-400">
                Learn and practice Luo language with our specialized AI translation model
              </p>
            </div>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-col space-y-4">
                    <h3 className="text-xl font-bold">Luo (Dholuo)</h3>
                    <p className="text-gray-500 dark:text-gray-400">
                      The language of the Luo people, a Nilotic ethnic group native to western Kenya and northern Tanzania. Known for their rich musical traditions and storytelling culture.
                    </p>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-col space-y-4">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Practice translating between English and Luo to improve your language skills and cultural understanding.
                    </p>
                    <div className="mt-auto pt-4">
                      <Button
                        className="w-full"
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                              Language: {conversation.language === 'luo' ? 'Luo (Dholuo)' :
